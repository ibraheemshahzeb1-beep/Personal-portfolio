...
* **Frontend:** HTML5, Tailwind CSS (for modern, responsive, and animated UI elements)
* **Editing Suites:** Adobe Creative Cloud, Filmora
* **Platform:** GitHub (for version control and hosting)

## 📁 Repository Structure
* `portfolio.html` - The main entry point of my portfolio website, featuring integrated responsive designs and custom animations.
* `README.md` - This documentation file providing an overview of the project.

## 🌐 How to View
To view the portfolio locally:
1. Clone or download this repository.
2. Open the `portfolio.html` file in any modern web browser (such as Google Chrome) with an active internet connection to fully render the Tailwind CSS animations and styles.
